# -*- coding: utf-8 -*-
#
# IMPACT-Pipeline documentation build configuration file, created by
...
htmlhelp_basename = 'IMPACT-Pipelinedoc'
...
latex_documents = [
  ('index', 'IMPACT-Pipeline.tex', u'IMPACT-Pipeline Documentation',
   u'Ronak H Shah, Donavan Cheng, Ahmet Zehir, Aijaz Syed, Raghu Chandramohan, Meera Prasad', 'manual'),
]
